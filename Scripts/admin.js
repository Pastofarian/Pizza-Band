...
function refreshPizzaHeader() {
    ...
    request("http://localhost/Pizza-Band/Controlers/js_ctrl_listColumns.php?name=pizza", function (httpRequest) {
...
function refreshPizzaTable() {
    ...
    request("http://localhost/Pizza-Band/Controlers/js_ctrl_listpizza.php", function (httpRequest) {
        let response = httpRequest.responseText;
        if (response == 'NULL') return;
...
function refreshIngreTable() {
    ...
    request("http://localhost/Pizza-Band/Controlers/js_ctrl_listingre.php", function (httpRequest) {
        let response = httpRequest.responseText;
        if (response == 'NULL') return;
...
function refreshSizeTable() {
    ...
    request("http://localhost/Pizza-Band/Controlers/js_ctrl_listsize.php", function (httpRequest) {
        let response = httpRequest.responseText;
        if (response == 'NULL') return;
...
function refreshDoughTable() {
    ...
    request("http://localhost/Pizza-Band/Controlers/js_ctrl_listdough.php", function (httpRequest) {
        let response = httpRequest.responseText;
        if (response == 'NULL') return;
